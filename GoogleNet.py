...
def google_net(x):
    ...
    weights = {'W_conv1':tf.Variable(tf.random_normal([7,7,7,1,64],stddev=math.sqrt(2/7*7*7*1))), # need to set stddev=math.sqrt(2/units) according to https://arxiv.org/abs/1502.01852
               ...
               'W_inception_3a_3x3':tf.Variable(tf.random_normal([3,3,3,96,128],stddev=math.sqrt(2/3*3*3*96))),
               'W_inception_3a_5x5_reduce':tf.Variable(tf.random_normal([1,1,1,192,16],stddev=math.sqrt(2/192))),
               'W_inception_3a_5x5':tf.Variable(tf.random_normal([5,5,5,16,32],stddev=math.sqrt(2/5*5*5*16))),
               'W_inception_3a_pool_proj':tf.Variable(tf.random_normal([1,1,1,192,32],stddev=math.sqrt(2/192))),

               'W_inception_3b_1x1':tf.Variable(tf.random_normal([1,1,1,256,128],stddev=math.sqrt(2/256))),
               'W_inception_3b_3x3_reduce':tf.Variable(tf.random_normal([1,1,1,256,128],stddev=math.sqrt(2/256))),
               'W_inception_3b_3x3':tf.Variable(tf.random_normal([3,3,3,128,192],stddev=math.sqrt(2/3*3*3*128))),
               'W_inception_3b_5x5_reduce':tf.Variable(tf.random_normal([1,1,1,256,32],stddev=math.sqrt(2/256))),
               'W_inception_3b_5x5':tf.Variable(tf.random_normal([5,5,5,32,96],stddev=math.sqrt(2/5*5*5*32))),
               'W_inception_3b_pool_proj':tf.Variable(tf.random_normal([1,1,1,256,64],stddev=math.sqrt(2/256))),

               'W_inception_4a_1x1':tf.Variable(tf.random_normal([1,1,1,480,192],stddev=math.sqrt(2/480))),
               'W_inception_4a_3x3_reduce':tf.Variable(tf.random_normal([1,1,1,480,96],stddev=math.sqrt(2/480))),
               'W_inception_4a_3x3':tf.Variable(tf.random_normal([3,3,3,96,208],stddev=math.sqrt(2/3*3*3*96))),
               'W_inception_4a_5x5_reduce':tf.Variable(tf.random_normal([1,1,1,480,16],stddev=math.sqrt(2/480))),
               'W_inception_4a_5x5':tf.Variable(tf.random_normal([5,5,5,16,48],stddev=math.sqrt(2/125*16))),
               'W_inception_4a_pool_proj':tf.Variable(tf.random_normal([1,1,1,480,64],stddev=math.sqrt(2/480))),

               'W_inception_4b_1x1':tf.Variable(tf.random_normal([1,1,1,512,160],stddev=math.sqrt(2/512))),
               'W_inception_4b_3x3_reduce':tf.Variable(tf.random_normal([1,1,1,512,112],stddev=math.sqrt(2/512))),
               'W_inception_4b_3x3':tf.Variable(tf.random_normal([3,3,3,112,224],stddev=math.sqrt(2/27*112))),
               'W_inception_4b_5x5_reduce':tf.Variable(tf.random_normal([1,1,1,512,24],stddev=math.sqrt(2/512))),
               'W_inception_4b_5x5':tf.Variable(tf.random_normal([5,5,5,24,64],stddev=math.sqrt(2/125*24))),
               'W_inception_4b_pool_proj':tf.Variable(tf.random_normal([1,1,1,512,64],stddev=math.sqrt(2/512))),

               'W_inception_4c_1x1':tf.Variable(tf.random_normal([1,1,1,512,128],stddev=math.sqrt(2/512))),
               'W_inception_4c_3x3_reduce':tf.Variable(tf.random_normal([1,1,1,512,128],stddev=math.sqrt(2/512))),
               'W_inception_4c_3x3':tf.Variable(tf.random_normal([3,3,3,128,256],stddev=math.sqrt(2/27*128))),
               'W_inception_4c_5x5_reduce':tf.Variable(tf.random_normal([1,1,1,512,24],stddev=math.sqrt(2/512))),
               'W_inception_4c_5x5':tf.Variable(tf.random_normal([5,5,5,24,64],stddev=math.sqrt(2/125*24))),
               'W_inception_4c_pool_proj':tf.Variable(tf.random_normal([1,1,1,512,64],stddev=math.sqrt(2/512))),

               'W_inception_4d_1x1':tf.Variable(tf.random_normal([1,1,1,512,112],stddev=math.sqrt(2/512))),
               'W_inception_4d_3x3_reduce':tf.Variable(tf.random_normal([1,1,1,512,144],stddev=math.sqrt(2/512))),
               'W_inception_4d_3x3':tf.Variable(tf.random_normal([3,3,3,144,288],stddev=math.sqrt(2/27*144))),
               'W_inception_4d_5x5_reduce':tf.Variable(tf.random_normal([1,1,1,512,32],stddev=math.sqrt(2/512))),
               'W_inception_4d_5x5':tf.Variable(tf.random_normal([5,5,5,32,64],stddev=math.sqrt(2/125*32))),
               'W_inception_4d_pool_proj':tf.Variable(tf.random_normal([1,1,1,512,64],stddev=math.sqrt(2/512))),

               'W_inception_4e_1x1':tf.Variable(tf.random_normal([1,1,1,528,256],stddev=math.sqrt(2/528))),
               'W_inception_4e_3x3_reduce':tf.Variable(tf.random_normal([1,1,1,528,160],stddev=math.sqrt(2/528))),
               'W_inception_4e_3x3':tf.Variable(tf.random_normal([3,3,3,160,320],stddev=math.sqrt(2/27*160))),
               'W_inception_4e_5x5_reduce':tf.Variable(tf.random_normal([1,1,1,528,32],stddev=math.sqrt(2/528))),
               'W_inception_4e_5x5':tf.Variable(tf.random_normal([5,5,5,32,128],stddev=math.sqrt(2/125*32))),
               'W_inception_4e_pool_proj':tf.Variable(tf.random_normal([1,1,1,528,128],stddev=math.sqrt(2/528))),

               'W_inception_5a_1x1':tf.Variable(tf.random_normal([1,1,1,832,256],stddev=math.sqrt(2/832))),
               'W_inception_5a_3x3_reduce':tf.Variable(tf.random_normal([1,1,1,832,160],stddev=math.sqrt(2/832))),
               'W_inception_5a_3x3':tf.Variable(tf.random_normal([3,3,3,160,320],stddev=math.sqrt(2/27*160))),
               'W_inception_5a_5x5_reduce':tf.Variable(tf.random_normal([1,1,1,832,32],stddev=math.sqrt(2/832))),
               'W_inception_5a_5x5':tf.Variable(tf.random_normal([5,5,5,32,128],stddev=math.sqrt(2/125*32))),
               'W_inception_5a_pool_proj':tf.Variable(tf.random_normal([1,1,1,832,128],stddev=math.sqrt(2/832))),

               'W_inception_5b_1x1':tf.Variable(tf.random_normal([1,1,1,832,384],stddev=math.sqrt(2/832))),
               'W_inception_5b_3x3_reduce':tf.Variable(tf.random_normal([1,1,1,832,192],stddev=math.sqrt(2/832))),
               'W_inception_5b_3x3':tf.Variable(tf.random_normal([3,3,3,192,384],stddev=math.sqrt(2/27*192))),
               'W_inception_5b_5x5_reduce':tf.Variable(tf.random_normal([1,1,1,832,48],stddev=math.sqrt(2/832))),
    ...
    pool5_normalized = tf.reshape(dropout1, [-1, 7*7*24*128])
